...
This CSV is the active runtime mapping source for M2000 telemetry. It should contain only the nodes SignalEyes wants to retrieve from the M2000, not the full M2000 register table.

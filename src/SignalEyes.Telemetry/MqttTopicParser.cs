...
{
    public const string TelemetryTopicPattern = "signaleyes/{tenantId}/{siteId}/{deviceId}/telemetry";
    ...
    public static bool TryParseTelemetryTopic(string topic, out MqttTopicParts parts)
    {
        ...
        if (segments.Length != 5 ||
            !segments[0].Equals("signaleyes", StringComparison.OrdinalIgnoreCase) ||

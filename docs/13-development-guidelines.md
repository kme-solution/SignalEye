...
- Use proof-of-concept code only as a behavior reference; rewrite implementation using SignalEye standards.
...
- Add tests around read-range grouping and max-register limits if SignalEye implements direct Modbus TCP polling.
